...
package com.resonant.wrapper.lib.asm;
...
import resonantengine.lib.asm.TemplateInjectionManager.InjectionTemplate;
...
public class TemplateTransformer implements IClassTransformer {
	static LaunchClassLoader cl = (LaunchClassLoader) TemplateTransformer.class.getClassLoader();
