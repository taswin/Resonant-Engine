...
import com.resonant.core.api.tile.IRemovable;
import com.resonant.lib.utility.inventory.InventoryUtility;
			...
			if (event.action == Action.RIGHT_CLICK_BLOCK) {
				...
				if (tile instanceof IRemovable) {
					...
					if (tile instanceof IRemovable.ICustomRemoval) {
						...
						do_drop = tile instanceof IRemovable.IPickup && event.entityPlayer.getHeldItem() == null;
					}
